...
namespace margelo::nitro::botsort {
  ...
  public:
    BoundingBox() = default;
    explicit BoundingBox(double x, double y, double width, double height, double confidence, double classId): x(x), y(y), width(width), height(height), confidence(confidence), classId(classId) {}
